      ...
      <div className="w-full max-w-md p-6 bg-card border border-border rounded-2xl shadow-card">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border rounded-xl bg-background hover:bg-muted/20 transition-colors disabled:opacity-50"
          >
            {loading === "google" ? (
